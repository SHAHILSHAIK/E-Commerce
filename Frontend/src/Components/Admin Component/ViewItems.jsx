...
export default function ViewItems() {
  ...
  return (
    <main>
      ...
      <section className="pt-24 py-6 bg-gray-50">
        <div className="">
          ...
          {/* Products Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 p-5 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  ...
                  <div
                    className="flex justify-center mb-4 bg-slate-100 cursor-pointer"
