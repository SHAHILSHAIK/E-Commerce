...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-100">
      {/* Sidebar */}
      <div className="w-full md:w-1/5 bg-gray-900 text-white p-4 shadow-lg fixed md:relative bottom-0 left-0 z-50">
      ...
      {/* Main Content */}
      <div className="flex-1 overflow-auto p-5 mt-[80px] md:mt-0">
        {Object.entries(categorizedProducts).map(([title, items], index) => (
          <div key={index} className="py-6 text-center">
            <div className="text-2xl text-center md:text-3xl font-extrabold uppercase flex items-center justify-center">
              {title}
                ...
                items.map((product) => (
                  ...
                  >
                    <div
                      ...
                      onClick={() => setSelectedImage(product.image)} // Open modal with clicked image
                    >
                      <img
